...
create table product (product_id bigint not null auto_increment, img_link varchar(255) not null, name varchar(255) not null, primary key (product_id)) engine=InnoDB;
